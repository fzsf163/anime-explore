...
export default async function Home() {
  ...
  return (
    <main>
      <section className="flex items-start justify-center mt-10 ">
        <div className="w-fit sticky top-10 pe-2">
          <h1 className="text-center text-4xl font-mono font-extrabold animate-pulse ">
            <svg
